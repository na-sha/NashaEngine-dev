...
namespace Nasha {
    ...
    public:
        class Builder {
        public:
            explicit Builder(VkSetup &device) : m_device{device} {}
        ...
        DescriptorSetLayout(VkSetup &lveDevice, const std::unordered_map<uint32_t, VkDescriptorSetLayoutBinding>& bindings);
        ~DescriptorSetLayout();
